...
// Google-family providers rate-limit token refreshes hard — space them out.
...
export async function runBackgroundTokenRefreshTick(deps = {}) {
  ...
  try {
    ...
    // Sequential with inter-account delays to prevent bursting upstream
    // providers (especially Google Cloud) — parallel refreshes trigger 429s.
