...
// Build TOML config for ORouter (openai provider mode)
const buildORouterConfig = (baseUrl, apiKey, model) => {
...
// Detect ORouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildORouterConfig(baseUrl, apiKey || "sk_9router", model);
