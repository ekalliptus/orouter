...
const hasORouterConfig = (globalState) => {
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      hasORouter: hasORouterConfig(globalState),
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "ORouter settings removed from Cline" });
  } catch (error) {
