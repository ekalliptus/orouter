...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      hasORouter: hasORouterConfig(auth),
...
export async function POST(request) {
  try {
    ...
    try {
      ...
      vscode["kilocode.customProvider"] = { name: "ORouter", baseURL: normalizedBaseUrl, apiKey };
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "ORouter settings removed from Kilo Code" });
  } catch (error) {
